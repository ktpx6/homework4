public class Main {
    public static void main(String[] args) {
        ...
        if (agePeople < 5) {
            System.out.println("Если возраст ребенка равен " + agePeople + ", то ему нельзя кататься на аттракционе.");}

        else if (agePeople >= 5 && agePeople < 14) {
            System.out.println("Если возраст ребенка равен " + agePeople + ", то он может кататься на аттракционе в сопровождении взрослого.");}

        else {
            System.out.println("Если возраст ребенка равен " + agePeople + ", то он может кататься на аттракционе без сопровождения взрослого.");}
